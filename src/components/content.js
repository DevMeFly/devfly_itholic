        ...
        <div className='w-full rounded-2xl bg-white p-4 shadow-lg dark:bg-gray-700'>
          ...
          <div className='m-auto block'>
            ...
            <div className='mt-2 h-2 w-full rounded-full bg-gray-200'>
              <div className='bg-purple-500 h-full w-1/2 rounded-full text-center text-xs text-white' />
            </div>
          </div>
          ...
          <span className='text-yellow-500 bg-yellow-100 mt-4 flex w-36 items-center rounded-md px-2 py-1 text-xs font-semibold'>
            DUE DATE : 18 JUN
          </span>
        </div>
      </div>
      <div className='mb-4'>
        <div className='w-full rounded-2xl bg-white p-4 shadow-lg dark:bg-gray-700'>
          ...
          <div className='my-4 flex items-center justify-start space-x-4'>
            ...
            <span className='text-yellow-600 bg-yellow-200 flex items-center rounded-md px-2 py-1 text-xs font-semibold'>
              ANDROID
            </span>
          </div>
          <div className='flex -space-x-2'>
    ...
    <div className='w-full sm:w-1/2 xl:w-1/3'>
      ...
      <div className='mb-4 sm:ml-4 xl:mr-4'>
        <div className='w-full rounded-2xl bg-white shadow-lg dark:bg-gray-700'>
          ...
          <div className='flex items-center justify-between border-l-4 border-blue-500 bg-blue-100 py-2 px-4 text-gray-600 dark:bg-gray-800'>
            ...
            <div className='flex items-center'>
              <span className='mr-2 ml-2 text-xs font-bold dark:text-gray-200 md:ml-4'>
                25 min 20s
              </span>
          ...
          <div className='flex items-center justify-between border-b-2 border-gray-100 py-2 px-4 text-gray-600'>
            <p className='flex items-center text-xs dark:text-white'>
              <svg
                width='20'
                height='20'
            ...
            <div className='flex items-center'>
              <span className='mr-2 ml-2 text-xs text-gray-400 md:ml-4'>
                30 min
              </span>
              <button className='mr-4 rounded border border-gray-400 p-1 text-sm text-gray-400'>
                <svg
          ...
          <div className='flex items-center justify-between py-2 px-4 text-gray-600'>
            <p className='flex items-center text-xs dark:text-white'>
              <svg
                width='20'
                height='20'
